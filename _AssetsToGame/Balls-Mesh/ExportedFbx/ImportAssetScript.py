...
#Use this command : py "/home/mpulcinelli/Develop/personal/games/TheHero/_AssetsToGame/Balls-Mesh/ExportedFbx/ImportAssetScript.py"
...
def ImportAllAssets():
	...
	def CreateTask_SM_Sphere():
		################[ Import Sphere as StaticMesh type ]################
		print('================[ New import task : Sphere as StaticMesh type ]================')
		FilePath = os.path.join(r'/home/mpulcinelli/Develop/personal/games/TheHero/_AssetsToGame/Balls-Mesh/ExportedFbx/StaticMesh/SM_Sphere.fbx')
		AdditionalParameterLoc = os.path.join(r'/home/mpulcinelli/Develop/personal/games/TheHero/_AssetsToGame/Balls-Mesh/ExportedFbx/StaticMesh/SM_Sphere_AdditionalParameter.ini')
		...
		if len(task.imported_object_paths) > 0:
			...
			asset = None
		if asset == None:
			ImportFailList.append('Asset "Sphere" not found for after inport')
			return
		print('========================= Imports of Sphere completed ! Post treatment started...	=========================')
		...
		print('========================= Post treatment of Sphere completed !	 =========================')
		unreal.EditorAssetLibrary.save_loaded_asset(asset)
		ImportedList.append([asset, 'StaticMesh'])
	CreateTask_SM_Sphere()
